...
#undef SYNTHESIS_SETTER
        ...
        void emit_socket(std::string const& name, message::list const& msglist, std::function<void (message::list const&)> const& ack);
    ...
    void socket::impl::emit_socket(std::string const& name, message::list const& msglist, std::function<void (message::list const&)> const& ack)
    {
        NULL_GUARD(m_client);
    ...
    void socket::emit_socket(std::string const& name, message::list const& msglist, std::function<void (message::list const&)> const& ack)
    {
        m_impl->emit_socket(name, msglist,ack);
    }

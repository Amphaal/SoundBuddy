...
# BUG REQUIRES AT LEAST 2 GENERATION OF INSTALLER TO ACK MODIFICATIONS !!! CACHING VARIABLES REQUIRED !
SET(CPACK_PACKAGE_INSTALL_DIRECTORY "${PROJECT_NAME}"                       CACHE STRING "..." FORCE)
SET(CPACK_NSIS_INSTALL_ROOT "$PROGRAMFILES64\\\\${APP_PUBLISHER_ORG}"       CACHE STRING "..." FORCE) # inspired by generated project.nsi
SET(CPACK_NSIS_PACKAGE_NAME "${PROJECT_NAME} ${CMAKE_PROJECT_VERSION}"      CACHE STRING "..." FORCE)
SET(CPACK_NSIS_DISPLAY_NAME "${PROJECT_NAME}"                               CACHE STRING "..." FORCE)
SET(CPACK_NSIS_MUI_FINISHPAGE_RUN "${CMAKE_PROJECT_NAME}.exe"               CACHE STRING "..." FORCE)
SET(CPACK_NSIS_ENABLE_UNINSTALL_BEFORE_INSTALL TRUE                         CACHE STRING "..." FORCE)
SET(CPACK_NSIS_IGNORE_LICENSE_PAGE TRUE                                     CACHE STRING "..." FORCE)
SET(CPACK_NSIS_MENU_LINKS 
    "bin/${CMAKE_PROJECT_NAME}.exe" "${CMAKE_PROJECT_NAME}"
                                                                            CACHE STRING "..." FORCE)
